...
num_workers
'''
class BunnyDataModule(pl.LightningDataModule):
    def __init__(self, args, preload= False):
        super().__init__()
        self.args = args
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/home/xxy/Documents/data/UVG/bunny', help='data path for vid')
    ...
    bunny_module = BunnyDataModule(args, preload=True)
